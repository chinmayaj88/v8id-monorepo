...
export {
  IAuditLogRepository,
  type AuditLog,
} from './audit-log-repository.interface.js';
...
export { ISuspiciousActivityService, type SuspiciousActivityDetectionResult } from './suspicious-activity-service.interface.js';