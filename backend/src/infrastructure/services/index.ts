...
export { SuspiciousActivityService } from './suspicious-activity.service';
...
export type { SuspiciousActivityDetectionResult } from '../../application/interfaces/suspicious-activity-service.interface';
