...
import { IDeviceSessionRepository, DeviceSession } from '../../../application/interfaces/index.js';
...
export class DeviceSessionRepository implements IDeviceSessionRepository {
  ...
  async countActiveSessionsByType(userId: string, deviceType: 'MOBILE' | 'WEB'): Promise<number> {
