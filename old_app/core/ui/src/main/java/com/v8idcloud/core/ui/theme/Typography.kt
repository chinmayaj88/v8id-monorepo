...
/**
 * v8id Cloud Typography System
 * Using Urbanist font family throughout the app
 * Clean, modern sans-serif typography matching design specifications
 */
val V8idTypography = Typography(
